...
<body>
				...
				<form id="frm" action="memberLogin.do" method="post">
					<table border="1">
						...
						<tr>
							...
							<td width="200"><input type="password" id="memberPw" name="memberPw" required="required"
					...
					<div>
						<input type="submit" value="로그인">&nbsp;&nbsp;&nbsp; <input type="reset"
							value="취 소">&nbsp;&nbsp;&nbsp; <input type="button" value="홈"
	...
	<a href="javascript:KakaoLogin();"> <img style="height: 60px; width: auto;"
